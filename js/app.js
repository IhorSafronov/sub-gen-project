(() => {
    ...
    function initSliders() {
        if (document.querySelector(".body-review")) new core(".body-review__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const blackPicker = document.getElementById("color-black-1");
    const whitePicker = document.getElementById("color-white-1");
    const blackImage = document.querySelector(".image-color__black-ibg");
    const whiteImage = document.querySelector(".image-color__white-ibg");
    blackImage.style.display = "block";
    whiteImage.style.display = "none";
    blackPicker.checked = true;
    blackPicker.addEventListener("change", (function() {
        blackImage.style.display = "block";
        whiteImage.style.display = "none";
    }));
    whitePicker.addEventListener("change", (function() {
        blackImage.style.display = "none";
        whiteImage.style.display = "block";
    }));
    const script_form = document.querySelector(".form-page");
    script_form.addEventListener("submit", (event => {
        ...
        const tokenCrm = "NTU5NGRmZTkxY2E1NjZjZmNjMTY3NzExZDJkOTAyOWMxYjkzMmFkMA";
        fetch("https://openapi.keycrm.app/v1/order", {
            ...
            if (!response.ok) throw new Error(`Ошибка при отправке данных в KeyCRM: ${response.status} ${response.statusText}`);
        })).catch((error => {
            console.error(error);
        }));
    }));
